...
#define STRING_CONFIG_H_AUTHOR "(Stepaniuk Denis, RenRen3d kossel)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Fraggett1Printer"
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 112.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 234.0      // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 263.4             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 130.0              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 150}  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define X_BED_SIZE ((100) * 2)
#define Y_BED_SIZE ((100) * 2)
...
//            https://github.com/olikraus/U8TFTglib_Arduino
//
